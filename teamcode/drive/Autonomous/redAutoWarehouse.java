...
public class redAutoWarehouse extends GorillabotsCentral {// 192.168.43.1:8080/dash
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory park2b = drive.trajectoryBuilder(park1b.end())
                ...
                .build();
        Trajectory park3 = drive.trajectoryBuilder(new Pose2d(36, -67.5, Math.toRadians(180)))
                //.lineToLinearHeading(new Pose2d(39, -45.5, Math.toRadians(180)))
                .strafeRight(24)
                .build();
        Trajectory park4 = drive.trajectoryBuilder(new Pose2d(38, -44.5, Math.toRadians(270)))
                //.strafeLeft(36)
                .lineToLinearHeading(new Pose2d(72, -47.3, Math.toRadians(270)))
                .build();
